...
public partial class Query
{
	...
	public void Foreach<T1, T2, T3, T4>(Operation<T1, T2, T3, T4> operation)
    {
	...
	public void Foreach<T1, T2, T3, T4, T5>(Operation<T1, T2, T3, T4, T5> operation)
    {
	...
	public void Foreach<T1, T2, T3, T4, T5, T6>(Operation<T1, T2, T3, T4, T5, T6> operation)
    {
	...
	public void Foreach<T1, T2, T3, T4, T5, T6, T7>(Operation<T1, T2, T3, T4, T5, T6, T7> operation)
    {
	...
	public void Foreach<T1, T2, T3, T4, T5, T6, T7, T8>(Operation<T1, T2, T3, T4, T5, T6, T7, T8> operation)
    {
